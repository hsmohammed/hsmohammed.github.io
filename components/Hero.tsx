...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-primary-50 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container-max section-padding relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-gradient-to-br from-primary-600 to-accent-600 rounded-2xl p-8 shadow-2xl">
            ...
            >
              <div className="text-xs text-gray-600">NLP</div>
              <div className="text-sm font-bold text-gray-900">99.2%</div>
            </motion.div>
            ...
            >
              <div className="text-xs text-gray-600">Computer Vision</div>
              <div className="text-sm font-bold text-gray-900">97.8%</div>
            </motion.div>
          </motion.div>
        </div>
      </div>
